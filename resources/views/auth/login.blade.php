...
<div class="col-md-8 col-lg-6 col-xl-5 mx-auto my-10p" id="login">
    <div class="text-center">
        <img src="{{ url('assets/img/w-logo.png') }}" alt="{{ settings('app_name') }}" height="50">
    </div>
    ...
    <div class="text-center text-muted">
        @if (settings('reg_enabled'))
            @lang('app.dont_have_an_account') <a class="font-weight-bold" href="<?= url("register") ?>">@lang('app.sign_up_p')</a>
        @endif
    </div>
